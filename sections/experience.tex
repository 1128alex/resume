\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Software Developer}{January 2025 - April 2025}
      % {AKCSE}
      ...
      {Waterloo, ON}
      \resumeItemListStart
        \resumeItem{Conveyed accountability and organization skills by analyzing and managing the cash flow of \textbf{\$1,000+} annual income and expenses using \textbf{Excel}.}
