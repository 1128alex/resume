\section{Experience}
  ...
  \resumeItemListStart
    ...
    \resumeItem{Generated \textbf{PowerBI} dashboards to deliver \textbf{data-driven insights} through statistical modeling and efficient data pipelines, and drove a \textbf{12\%} increase in average test scores.}
...
\resumeSubheading
  ...
  {Waterloo, ON}
  \resumeItemListStart
    \resumeItem{Led the \textbf{team of 6} to develop the official AKCSE website using \textbf{Express} and \textbf{MongoDB}, improving accessibility to career and academic help resources for University of Waterloo students.}
