 %-----------EXPERIENCE-----------
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Boosted average test scores by \textbf{12\%} by designing \textbf{PowerBI} dashboards and conducting exploratory analysis built from cleaned and normalized student performance data in \textbf{Excel}.}
        ...
        \resumeItem{Delivered \textbf{data-driven insights} through accurate statistical analysis and clear communication, which instructors used to design and offer an adaptive education system that maximized study efficiency.}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Optimized query efficiency and scalability by \textbf{300\%} by implementing \textbf{dynamic CRUD}, while implementing \textbf{authentication} and access control features to strengthen data security.}
