...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Waterloo, ON}
      \resumeItemListStart
        \resumeItem{Conveyed accountability and organization skills by analyzing, managing, and visualizing the cash flow of the organization using \textbf{Excel} to reduce reporting time by \textbf{30\%}.}
        ...
        \resumeItem{Reduced \textbf{10\%} of unnecessary expenditures by writing annual financial reports to identify inefficiencies and recommended actionable strategies for better financial management.}
