\providecommand{\Role}{Database Developer}
\resumeSubheading
    {\Role}{May. 2025 - Aug. 2025}
      ...
      \resumeItemListStart
        ...
        \resumeItem{Optimized query efficiency and database scalability by \textbf{42\%} through implementation of \textbf{dynamic CRUD}, while implementing \textbf{authentication} and access control features to strengthen data security.}
